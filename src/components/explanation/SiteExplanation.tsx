...
export default function SiteExplanation() {
  ...
  You can select from as many RSS feeds as you'd like, and use the slider to control how many articles you want (limit of 20 for each RSS feed). You can also open up the 'Personal' tab to generate articles from your favourite RSS feeds. By default we have links to the source website turned off but you can press the 'Toggle Links' button to enable them on.
  ...
  return <BaseExplanation title="How It Works" content={content} initiallyExpanded={false} />;
}
